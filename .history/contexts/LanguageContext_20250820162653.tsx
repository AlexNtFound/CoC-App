...
const translations = {
  en: {
    ...
    profile: {
      ...
      myPrayerRequests: 'My Prayer Requests',
      myPrayerRequestsDesc: 'View and manage your prayer requests',
  ...
  zh: {
    ...
    profile: {
      ...
      myPrayerRequests: '我的祷告请求',
      myPrayerRequestsDesc: '查看和管理您的祷告请求',
